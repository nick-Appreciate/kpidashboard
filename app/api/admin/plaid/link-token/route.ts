 ...
 *
 * Products requested: Auth + Transactions. Balance is not a standalone product
 * in the current Plaid API — /accounts/balance/get is available on any Item
 * with any product initialized. Transactions is needed so we can reconstruct
 * historical daily balances by walking backwards from current balance.
 */
