      ...
      <div className="px-6 md:px-8 pb-6 md:pb-8">
        ...
        {!stats?.hasData ? (
          ...
          <>
            ...
            {/* The Move-In / Move-Out Activity panel and the Churn Metrics
                section (churn rate + tenancy length) used to live here.
                Both depended on rollups that were producing misleading
                numbers, so they've been removed pending a rework. */}
