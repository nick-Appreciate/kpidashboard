    ...
    if (tenancyChartRef.current && rows.length) {
      ...
      tenancyChartRef.current.chart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: 'Mean tenancy at exit — under our ownership (months)',
            ...
            {
              label: 'Mean tenancy at exit — full lease history (months)',
              data: rows.map(r => r.mean_tenancy_at_exit_raw_months),
